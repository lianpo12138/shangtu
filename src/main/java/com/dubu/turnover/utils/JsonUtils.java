...
public class JsonUtils {
     ...
     * @param jsonString 集合类型
     * @return 转换失败时返回 null
     */
    public static <L extends Collection<E>, E> L fromJson(String jsonString, Class<L> collectionClass, Class<E> elementClass) throws Exception {
        if (StringUtils.isBlank(jsonString)) {
     ...
     * @return 转换失败时返回 null
     */
    public static <L extends Collection<E>, E> L fromJson(Object object, Class<L> collectionClass, Class<E> elementClass) throws IllegalArgumentException {
        if (null == object) {
            return null;
        }
        try {
